...
| `Grant/` | NSF CDS&E proposal draft on the same research program. |
| `Weekly_Meeting_Report/` | Beamer slide deck for advisor meetings. |
| `Personal_Weekly_Update/` | Written progress logs. |
